...
public class testerProgram {
	...
	while(true) {
		...
		if(decide.equals("Student") ||decide.equals("student")) {	
    		...
    		Student stu1 = new Student ("234802","Jose", "07/12/98",45000.00);
    		stu.add(stu1);
    		
    		Student stu2 = new Student ("732194","Emily", "12/06/67",80000.00);
    		stu.add(stu2);
        	
    		Student stu3 = new Student ("917284","Michael", "04/16/02",25000.00);
    		stu.add(stu3);
